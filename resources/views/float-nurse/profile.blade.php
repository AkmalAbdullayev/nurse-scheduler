    ...
    <div class="views">
        <div class="container-fluid mb-5">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('float-nurse.call-out.index') }}">Nurses</a></li>
                    <li class="breadcrumb-item active" aria-current="page">View nurse profile</li>
                </ol>
            </nav>
            <div class="views__inputs">
                <form action="{{ route('float-nurse.update') }}" method="post">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="views__inputs-footer">
                        <div>
                            <a role="button" class="btn-reset btn__outline"
                               href="{{ route('float-nurse.call-out.index') }}">Cancel</a>
                        </div>
                        <div>
