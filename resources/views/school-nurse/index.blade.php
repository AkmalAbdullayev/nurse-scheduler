        ...
        <div class="container-fluid">
            ...
            <nav>
                <div class="nav nav-tabs tabs-desktop" id="nav-tab" role="tablist">
                    <button class="nav-link @if(!session()->has('call-out')) active @endif" id="myPorfile-tab"
                            data-bs-toggle="tab" data-bs-target="#myPorfile"
                            type="button"
                    ...
                    @if($schoolNurse->schools->isNotEmpty())
                        <button class="nav-link @if(session()->has('call-out')) active @endif" id="outs-tab"
                                data-bs-toggle="tab" data-bs-target="#outs" type="button"
            ...
            <!-- top tabs content   -->
            @if ($schoolNurse->active_for_assignments)
                <div class="tab-content" id="nav-tabContent">
                    <!-- button  myPorfile    -->
                    <div
                        class="tab-pane tabPane fade @if(!session()->has('call-out')) active show @endif"
                        id="myPorfile"
                        role="tabpanel"
                    ...
                    >
                        ...
                        >
                            <h3 class="tab-pane-title"
                                style="font-weight: 700;font-size: 20px;line-height: 23px;color: #000000;">
                                My Profile</h3>
                            <div class="tab-pane-content">
                                <div>
                                    <h4 class="tab-pane-content-title"
                                        style="font-weight: 500;font-size: 16px;line-height: 19px;color: #000000;">
                                        Name</h4>
                                    <p class="tab-pane-content-desc"
                                       style="font-weight: 400;font-size: 16px;line-height: 19px;color: #000000;">
                            ...
                            <div class="tab-pane-content">
                                <div>
                                    <h4 class="tab-pane-content-title"
                                        style="font-weight: 500;font-size: 16px;line-height: 19px;color: #000000;">B.
                                        Code</h4>
                                    <p class="tab-pane-content-desc @if($schoolNurse->schools->isEmpty()) text-danger @endif"
                                       style="font-weight: 400;font-size: 16px;line-height: 19px;color: #000000;">{{ $schoolNurse->schools->last()?->building_code ?? 'School not assigned or deleted' }}</p>
                                </div>
                                <div>
                                    <h4 class="tab-pane-content-title"
                                        style="font-weight: 500;font-size: 16px;line-height: 19px;color: #000000;">
                            ...
                            <div class="tab-pane-content mt-4">
                                <div>
                                    <h4 class="tab-pane-content-title"
                                        ...
                                        School</h4>
                                    <p class="tab-pane-content-desc @if($schoolNurse->schools->isEmpty()) text-danger @endif"
                                       style="font-weight: 400;font-size: 16px;line-height: 19px;color: #000000;">{{ $schoolNurse->schools->last()?->school_name ?? 'School not assigned or deleted' }}</p>
                                </div>
                            </div>

                            {{--                        <input type="hidden" name="school_id" value="{{ $schoolNurse->schools->last()?->id }}">--}}
                            @if($schoolNurse->schools->isEmpty())
                                <button type="submit" class="btn-reset text-center disabled__btn" disabled>
                                    Register a call-out
                                </button>
                            @else
                    ...
                    @include('school-nurse.call-outs')
                </div>
                    ...
                    <div class="box">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <a href="{{ route('school-nurse.profile') }}">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <p class="modal-body-desc"> January 5, 2023 day.</p>
                        <p class="modal-body-center">Are you sure?</p>
                        <div class="modal-body-btn">
                            <button class="modal-body-btn-outline btn-reset" data-bs-dismiss="modal">Cancel</button>
                            <button class="modal-body-btn-green btn-reset">Confirm</button>
                        </div>
                    </div>
                </div>
            </div>
